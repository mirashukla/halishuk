...
class Blackhole(pygame.sprite.Sprite):
    ...
    def __init__(self, width_of_window, height_of_window, image_path):
        ...
        self.size_of_image = (150,150)                        # set desire size of image
    ...
    def start_y(self,height_of_window):
        ...
        start_y = (height_of_window -img_size_y) // 2  # Put image at bottom of screen and offset by img size
        return start_y
...
if __name__ == "__main__":
    ...
    object_with_image = Blackhole(WIDTH, HEIGHT, img_path)
